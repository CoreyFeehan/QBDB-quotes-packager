...
Pull Quotes from QuickBooks using QODBC to determine what box(es) items are going into, and return a shipping quote using your fedex/USPS account.
...
**Also the Length/Width/Height is for the minimum that item can be broken down into of the item whereas weight is always for one of that item.**
...
config.py contains your API key for FedEx and Shippo
...
SHIP_FROM has your shipping from address.
